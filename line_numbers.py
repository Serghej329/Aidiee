...
class LineNumbers(QWidget):
    def __init__(self, code_editor):
        ...
        self.highlight_color = QColor("#49483e")  # Default highlight color
        self.line_number_color = QColor("#f8f8f2")  # Default line number color
        self.current_line_number_color = self.highlight_color  # Color for the current line number
    ...
    def paintEvent(self, event):
        ...
        painter.fillRect(event.rect(), QColor("#272822"))  # Background color
